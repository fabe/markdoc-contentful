...
(function (mod) {
    if (typeof exports == 'object' && typeof module == 'object')
      // CommonJS
      mod(require('codemirror'), require('codemirror/mode/xml/xml'));
    else if (typeof define == 'function' && define.amd)
      // AMD
      define(['../CodeMirror/lib/codemirror', '../CodeMirror/mode/xml/xml'], mod);
    // Plain browser env
    else mod(CodeMirror);
  })(function (CodeMirror) {
    'use strict';
    ...
    CodeMirror.defineMode(
      'markdoc',
      function (config) {
        // This is a combination of Markdown and the Liquid templating engine
        // syntax's
        ...
        xmlMode.electricInput = RegExp(
          xmlMode.electricInput.source +
            /|^\s*{%-?\s*end(comment|raw)\s*-?%}$/.source
        );
    ...
    CodeMirror.defineMIME('text/x-markdoc', 'markdoc');
  });